// Sample data for <kc-conversations> non-scalar props.
//
...
export default {
  ...
  named: {
    ...
    // Declarative children — <kc-conversation> light-DOM children instead of a
    // JS `conversations` property. Great for plain HTML / server-rendered markup.
    declarative: {
      html: '<kc-conversation id="c-1">Q2 launch plan</kc-conversation><kc-conversation id="c-2">API migration notes</kc-conversation><kc-conversation id="c-3">Weekend trip ideas</kc-conversation>',
    },
  },
};
