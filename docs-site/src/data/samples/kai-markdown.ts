...
- Drop in \`<kai-chat>\` for a full conversational UI
- Use \`<kai-markdown>\` to render model output anywhere
- Compose with \`<kai-code-block>\` for highlighted snippets
...
const md = document.querySelector('kai-markdown') as HTMLElement & { content: string };
