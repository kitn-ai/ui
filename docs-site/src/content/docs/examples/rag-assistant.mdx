...
<p class="kai-lede">A knowledge-base assistant that grounds every answer in retrieved documents. The reply body uses `[1]`, `[2]`, `[3]` markers; `<kai-sources numbered>` renders the matching citation strip below. Ask something to see a new streamed answer with citations.</p>
