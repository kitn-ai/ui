...
- **[Artifacts canvas](/examples/artifacts-canvas/)** — the always-on version: a file tree and canvas docked beside the chat.
- **[`kai-artifact` reference](/components/artifact/)** — the Preview/Code toggle, sandbox flags, and navigation toolbar.
- **[`kai-message` reference](/components/message/)** — custom actions, attachments, and the `kai-message-action` event.
- **[Resizable split](/patterns/resizable-split/)** — sizing and dragging the two panes.
