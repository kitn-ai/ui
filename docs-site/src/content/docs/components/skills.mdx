...
<p class="kc-tag-sub">kai-skills</p>

<p class="kc-lede">A horizontal strip of skill badges — set a JS array or compose declarative `<kai-skill>` children to annotate a message with the tools it used.</p>
