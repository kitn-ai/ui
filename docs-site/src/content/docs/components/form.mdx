...
<p class="kc-tag-sub">kai-form</p>

<p class="kc-lede">Point a JSON Schema at `<kai-form>` and get a fully themed, accessible, client-validated form — labels, widgets, submit button, and a read-only resolved state — without writing a single input element.</p>
