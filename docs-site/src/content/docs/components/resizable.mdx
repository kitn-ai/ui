...
<p class="kc-tag-sub">kai-resizable</p>

<p class="kc-lede">Compose a draggable multi-panel shell — sidebar + chat, list + inspector, three-up — by placing `<kai-resizable-item>` children inside; dividers, drag logic, keyboard resize, and expand-to-fill are handled for you.</p>
