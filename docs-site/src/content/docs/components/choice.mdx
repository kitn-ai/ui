...
<p class="kc-tag-sub">kai-choice</p>

<p class="kc-lede">A "pick one of N" card — set the options in JavaScript, the user chooses one, and your app receives a typed `kai-card` action event.</p>
