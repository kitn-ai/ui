...
- [Getting Started](/chat/guides/getting-started/) — streaming replies with `kai-chat`
- [`kai-chat` component reference](/chat/components/chat/) — all props and events, including `loading`
