...
<Aside type="tip" title="You may not need this page">
**Register all** — `import '@kitn.ai/ui/elements'` — is the default, works everywhere (including SSR), and is completely fine: one import, every element ready. This page is purely for when you want to *trim what a page downloads*. If that's not a concern, skip it — nothing here is required.
</Aside>
