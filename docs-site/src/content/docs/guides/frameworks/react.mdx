---
title: React
description: Use kitn-chat's typed React wrappers to drop kai-* web components into any React app with idiomatic JSX, typed props, and onX event handlers.
---
...
`kai-image` exports as `Image`, which shadows the browser global. Alias it on import: `import { Image as KcImage } from '@kitn.ai/ui/react'`.
</Aside>
