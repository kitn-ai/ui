---
title: Solid
description: Use kitn-chat's native SolidJS components from @kitn.ai/ui for full compositional control, or drop in the kc-* web components for a batteries-included shell.
---
...
- **`kc-*` web components** (`@kitn.ai/ui/elements`) — the drop-in shells when you want batteries included or need to share UI across frameworks.
