...
description: Import AI/UI's headless primitives, UI primitives, and feature components straight from @kitn.ai/ui for full compositional control in a Solid app.
---
...
See the full [State helpers & hooks](/guides/state-and-hooks/) guide for the setter contract, streaming loop, and multi-chat usage.
