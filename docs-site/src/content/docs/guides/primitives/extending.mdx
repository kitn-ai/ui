...
description: Add a UI primitive, give it a story, and expose it as a kai-* web component — the full path through AI/UI's layers, with the Switch as a worked example.
---
