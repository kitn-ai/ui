...
//
// Same virtual-module machinery as ./../web-components/web-component/inline-web-component-types.test.ts.
...
const PREAMBLE = [
  ...
  `import type { Source } from '../web-components/chat/chat-types';`,
