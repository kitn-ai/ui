...
// merged here when `src/ui/` was folded into `src/components/`.
...
// Split out of the handle-affordance suite below; the handle paints one of two
// affordances, so each assertion is paired with the other one's absence.
