    ...
    <Show
      ...
      fallback={
        <div
          ...
          class={cn(
            'flex items-center gap-2 rounded-xl border border-destructive/40 bg-destructive/10 px-3 py-2 text-sm text-destructive-text dark:border-red-400/50 dark:bg-destructive/20',
            local.class,
          )}
        >
