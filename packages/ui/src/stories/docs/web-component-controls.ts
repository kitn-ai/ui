 ...
 * (`tag` is kept in the signature so callers don't churn.) The full per-web-component
...
/**
 * Parse a type string from web-component-meta.json into meaningful parts.
 *
...
const isBooleanParts = (parts: string[], rawType: string): boolean => {
  ...
  // web-component-meta encodes booleans as "undefined | false | true"
