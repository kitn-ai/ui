...
import { ResizableHandle, normalizeSize, clampBasis } from '../components/resizable/resizable';
...
defineWebComponent<GroupProps, GroupEvents>('kai-resizable', {
  ...
  onMount(() => {
    ...
    // so gen-web-component-api.mjs sees it and the generated element interface carries
...
defineWebComponent<ItemProps>('kai-resizable-item', {
  ...
  // in tests/web-components/reflected-boolean-coverage.test.ts for why `hidden` is a
