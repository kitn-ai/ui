 ...
 *
 * The variant list is DERIVED from the union in src/web-components/chat/chat-types.ts and
...
function messagePartVariants() {
  ...
  const file = resolve(ROOT, 'src/web-components/chat/chat-types.ts');
  ...
  if (!alias)
    fail(
      'no `type MessagePart = …` alias in src/web-components/chat/chat-types.ts.\n' +
