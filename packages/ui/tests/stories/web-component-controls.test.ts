/**
 * TDD tests for argTypesFor() in src/stories/docs/web-component-controls.ts
 *
 * The bug: web-component-meta.json encodes booleans as "undefined | false | true"
...
import { argTypesFor } from '../../src/stories/docs/web-component-controls';
