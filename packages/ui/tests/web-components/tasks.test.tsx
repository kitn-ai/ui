...
async function mount(data: TasksCardData, cardId = 'card-plan-42') {
  // No cast — this is a real KaiTasksElement now. See the long note in
  // choice.test.tsx: the old `as HTMLElement & { data: TasksCardData }` could
  ...
  // choice.test.tsx, and keep this line bare so it can still fail.
  el.data = data;
