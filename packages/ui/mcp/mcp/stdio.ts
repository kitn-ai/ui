 ...
 * packages/kai/config/vite/node.ts (the CLI's build; see that file for why the
 * sources stay here) and launched by packages/kai/bin/mcp.js, which handles fatal errors / exit (this file stays free of Node
