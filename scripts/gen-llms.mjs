...
> SolidJS + Shadow-DOM web component kit for building AI chat interfaces. ${count} \`kitn-*\` custom elements: streaming responses, markdown + code rendering, reasoning/tool panels, attachments, conversation sidebar, voice input. Zero framework dependency for consumers; SolidJS is bundled in.
