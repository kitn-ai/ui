...
// mounting, and Vue's `:prop.prop` bindings then land on UPGRADED elements. Raw
// web-component consumers have no upgrade-race guard (unlike the React wrappers), so
// a property set before upgrade is lost and static seed data never re-applies.
// Attributes survive upgrade; array/object properties do not.
