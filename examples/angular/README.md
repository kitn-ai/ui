...
`@kitn.ai/chat` web components natively — **no wrappers needed**.
...
The Vite config aliases `@kitn.ai/chat/elements` to the local `../../dist/kitn-chat.es.js`
...
- `src/stubs/` — minimal `.d.ts` stubs that redirect `@kitn.ai/chat/elements`
