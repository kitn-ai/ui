...
export const THREADS: Record<string, Msg[]> = {
  ...
  c2: [
    ...
    { id: 'c2a', role: 'assistant', content: "Feed your `messages` to a `<kai-thread>`, put a `<kai-prompt-input>` below, and wire `kai-submit` to append + stream. That's exactly what this example does. Read `app.ts`." },
  ],
  c3: [
