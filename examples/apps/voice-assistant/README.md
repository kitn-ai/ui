...
FILES: packages/ui/src/primitives/use-speech-recognition.ts, packages/ui/src/components/voice-input.tsx + voice-output.tsx (+ their tests), packages/ui/src/web-components/voice-input.tsx + voice-output.tsx (+ element tests), build:api-derived artifacts, examples/apps/voice-assistant/src/main.ts + README.md
