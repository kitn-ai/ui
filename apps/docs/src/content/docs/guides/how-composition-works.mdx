...
Every web component's exact holes and styleable regions live in its own page under **Slots** and **Styling** (e.g. [`kai-chat`](/components/chat/), [`kai-message`](/components/message/), [`kai-prompt-input`](/components/prompt-input/)).
