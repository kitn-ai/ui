...
- [Installation](/guides/installation/) — register the web components and add the theme.
- [Text to Speech](/guides/recipes/text-to-speech/) — the reverse direction: stream synthesized audio from the assistant.
