...
<MockSite client:only="solid" chatTitle="Help" suggestions={["How do I reset my password?", "What are your pricing tiers?"]} messages={[
  { id: 'w0', role: 'assistant', parts: [{ type: 'text', text: "Hi! I'm the docs assistant. Ask me anything, or scroll the page behind me — I stay put." }] },
]} />
...
- **The runnable version** — `examples/apps/support-widget/` in the repo is this page's widget as a real app: a Vite front end, a dev-server `/api/chat`, and replies streamed through `readOpenAIStream`. Its `README.md` covers running it against a mock or a live provider.
