---
title: Scope Picker
description: A dropdown that narrows a chat or a search to one author or tag.
---
...
<p class="kai-lede">Splits the choices into authors and tags, so a reader can filter on either.</p>
...
In a chat header or above a conversation list, when the history holds more than one author or tag. For the model picker it often sits beside, use [Model switcher](/components/model-switcher/).
</Aside>
...
<MethodTable tag="kai-scope-picker" />
