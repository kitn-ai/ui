...
<p class="kai-lede">A collapsible thinking block that auto-expands while the model's thought streams in and collapses when streaming stops — no wiring required.</p>
