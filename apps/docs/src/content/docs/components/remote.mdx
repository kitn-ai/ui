---
title: Remote
description: Runs a card from another origin inside a sandboxed frame.
---
...
<p class="kai-lede">Brings a provider's own card into the page while routing its events back to your app.</p>
...
For a card whose code you cannot bundle into the host app, because another team ships it on its own cycle. For a card you bundle yourself, use [Cards](/components/cards/).
