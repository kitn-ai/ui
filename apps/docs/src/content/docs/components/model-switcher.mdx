...
description: A dropdown for choosing the active model.
---
...
<p class="kai-lede">Stays invisible until two models are on offer, so a single-model app shows nothing.</p>
...
In a chat header, wherever the model in use should stay visible and swappable, often beside a [Context](/components/context/) meter.
</Aside>
...
<DeclarativeChildrenTable tag="kai-model-switcher" />
...
<MethodTable tag="kai-model-switcher" />
