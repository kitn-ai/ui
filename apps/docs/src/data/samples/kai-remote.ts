// Sample data for <kai-remote> non-scalar props. One file per element;
...
//
// kai-remote has two non-scalar props:
...
//                the kai-card bubbling event is sufficient for docs purposes)
//
