  ...
  parameters: {
    ...
    docs: {
      description: specDescription('kc-response-stream', [
          ...
          "**How to use:** register once with `import '@kitn.ai/ui/elements'`, set the `text` **property** (string or async iterable), tune `mode` (`typewriter` / `fade`) and `speed`, and listen for the `kc-complete` **CustomEvent**.",
