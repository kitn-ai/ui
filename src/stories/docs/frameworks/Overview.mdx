...
[HTML](./Html) · [React](./React) · [Solid](./Solid) · [Vue](./Vue) · [Svelte](./Svelte) · [Angular](./Angular).
...
The kit ships **41 elements**. SolidJS apps can also import the **native components** directly for
full compositional control — see the [Solid](./Solid) page and the **Solid (Advanced)** section.
